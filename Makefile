...
dist: clean_dist
	mkdir -p dist
	node_modules/.bin/uglifyjs -b ascii_only=true,beautify=false libs/pako.min.js minipdf.js pdfform.js -o dist/pdfform.minipdf.dist.js --source-map base="root='./'"
	node_modules/.bin/uglifyjs -b ascii_only=true,beautify=false libs/pako.min.js customlibs/pdf.worker.js minipdf_js.js pdfform.js -o dist/pdfform.pdf_js.dist.js --source-map base="root='./'"
